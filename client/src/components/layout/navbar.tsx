            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              {navLinks.map((link) => (
                <button 
                  ...
                  } inline-flex items-center px-1 pt-1 text-sm font-medium cursor-pointer no-underline bg-transparent border-0`}
                  onClick={() => {
                ...
                <div className="px-2 pt-2 pb-3 space-y-1">
                  {navLinks.map((link) => (
                    <button 
                      ...
                      } block px-3 py-2 rounded-md text-base font-medium cursor-pointer no-underline bg-transparent border-0 w-full text-left`}
                      onClick={() => {
                        console.log('Mobile button clicked:', link.href);
                        setIsOpen(false);
                        handleNavigation(link.href);
                      }}
                    >
