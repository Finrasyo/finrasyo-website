      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <a href="#" className="text-sm text-neutral-600 hover:text-primary">Sektör Analizi</a>
              </li>
              <li>
                <a href="#" className="text-sm text-neutral-600 hover:text-primary">API Erişimi</a>
              </li>
            </ul>
          </div>
          
          <div className="col-span-1">
            <h3 className="text-sm font-semibold text-neutral-800 uppercase tracking-wider">Destek</h3>
            <ul className="mt-4 space-y-2">
              <li>
                <a href="#" className="text-sm text-neutral-600 hover:text-primary">Yardım Merkezi</a>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <a href="#" className="text-sm text-neutral-600 hover:text-primary">Blog</a>
              </li>
              <li>
                <a href="#" className="text-sm text-neutral-600 hover:text-primary">Gizlilik Politikası</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-neutral-200 flex flex-col md:flex-row justify-between items-center">
          <div className="flex space-x-6 md:order-2">
            <select className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-neutral-300 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm rounded-md">
